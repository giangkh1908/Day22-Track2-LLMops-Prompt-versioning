...
# TODO hoàn thành: Copy SYSTEM_V1 từ file 02_prompt_hub_ab_routing.py
SYSTEM_V1 = (
...
# TODO hoàn thành: Copy SYSTEM_V2 từ file 02_prompt_hub_ab_routing.py
SYSTEM_V2 = (
...
def run_rag(retriever, llm, prompt, question: str) -> dict:
    ...
    """
    # TODO hoàn thành: Retrieve documents từ retriever.
    docs = retriever.invoke(question)

    # TODO hoàn thành: Tạo contexts là danh sách page_content (KHÔNG ghép chuỗi ở đây).
    # Gợi ý: contexts = [doc.page_content for doc in docs]
    contexts = [doc.page_content for doc in docs]   # phải là list[str] !

    # TODO hoàn thành: Ghép contexts thành 1 string để truyền vào {context} của prompt.
    ctx_str = "\n\n".join(contexts)

    # TODO hoàn thành: Chạy chain (prompt | llm | StrOutputParser()).invoke(...).
    answer = (prompt | llm | StrOutputParser()).invoke({
        "context":  ctx_str,
        "question": question,
    })

    # TODO hoàn thành: Trả về dict với answer và contexts (list).
...
def collect_rag_outputs(vectorstore, prompt_version: str) -> list:
    ...
    for i, qa in enumerate(QA_PAIRS, 1):
        # TODO hoàn thành: Gọi run_rag() cho câu hỏi hiện tại.
        out = run_rag(retriever, llm, prompt, qa["question"])

        # TODO hoàn thành: Append vào results dict với 4 keys.
        results.append({
...
def build_ragas_dataset(rag_results: list) -> EvaluationDataset:
    ...
    """
    # TODO hoàn thành: Tạo list các SingleTurnSample từ rag_results.
    samples = [
        SingleTurnSample(
    ...
    # TODO hoàn thành: Wrap thành EvaluationDataset và trả về.
...
def run_ragas_eval(rag_results: list, version: str) -> dict:
    ...
    # TODO hoàn thành: Tạo EvaluationDataset từ rag_results.
    ...
    # TODO hoàn thành: Gọi evaluate() với đầy đủ 4 metrics.
    # Gợi ý:
    #   result = evaluate(
    #       dataset,
...
def main():
    ...
    # TODO hoàn thành: Tạo vectorstore.
    ...
    # TODO hoàn thành: Lưu báo cáo vào data/ragas_report.json.
    report = {
    ...
    # TODO hoàn thành: Ghi report vào file bằng json.dumps hoặc json.dump.
